...
/// Prover-side witness produced by Step 1 (Commitment) of the protocol (paper p. 19).
///
...
impl<F: FftField> Config<F> {
    /// **Step 1 — Commitment** (paper p. 19, "Alternative Randomness Sampling").
    ///
        ...
        Hash: ProverMessage<[H::U]>,
    {
        ...
        // msk is fresh per witness to preserve ZK for each fᵢ (paper p. 16, NOTE).
        ...
        // Step 1b: Commit [[f̂]] via first WHIR instance (paper p. 19).
        ...
        // Step 1c: Sample ν + 1 random ℓ-variate blinding polynomials ĝ₀..ĝ_ν (paper p. 16).
        ...
        // Step 1d: Build committed vectors for second WHIR instance (paper p. 16).
        ...
        // stored as interleaved [gⱼ[k], 0] (paper p. 16: "coefficient for t is zero").
